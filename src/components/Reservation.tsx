...
export default function Reservation() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const message = encodeURIComponent(
      `Bonjour Swiss Palace, je souhaite faire une réservation :\n\n` +
      `👤 Nom : ${formData.name}\n` +
      `📅 Date : ${formData.date}\n` +
      `🕒 Heure : ${formData.time}\n` +
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-400 text-lg mb-10 leading-relaxed max-w-lg">
              Assurez-vous une place au cœur du Plateau. Que ce soit pour un dîner d'affaires, une soirée entre amis ou un moment lounge, nous préparons votre accueil avec soin.
            </p>
            ...
            {isSubmitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-400">
                  Nous avons ouvert WhatsApp pour finaliser votre réservation. À très bientôt au Swiss Palace.
                </p>
                <button 
